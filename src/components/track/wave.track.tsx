...
const WaveTrack = () => {
  const containerRef = useRef<HTMLDivElement>(null);
    // ref gắn liền với html, nhưng html chỉ tồn tại sau khi react render ra lần đầu
  ...
  // useCallback sẽ không chạy lại nếu biến có giá trị không đổi
